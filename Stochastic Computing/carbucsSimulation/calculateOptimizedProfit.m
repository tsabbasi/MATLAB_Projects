function [totalRevenue, totalExpenses, initialProfit, netProfit] = calculateOptimizedProfit(days)
...
omega = ["hot_coffee", "sandwich", "cold_coffee", "pastry", "car_wash", "car_wax", "gas", "sandwich_&_cold_coffee", "pastry_&_hot_coffee", "wash_&_wax"];
...
revenue = [5.00, 5.50, 5.00, 3.50, 10.00, 4.00, 25.00, 10.50, 8.50, 29.00];
...
% fprintf("\nOverall Net Profit is %.2f%% or %.0f%%\n", profitPercentage*100, round(profitPercentage*100));

revPerDay = totalRevenue/days;
netProfitPerDay = netProfit/days;
profitPerDayPercentage = netProfitPerDay/revPerDay;
% fprintf("Net Profit Per Day is %.2f%% or %.0f%%\n", profitPerDayPercentage*100, round(profitPerDayPercentage*100));

...
[rev1, exp1, prof1, netProf1] = calculateProfit(Jan);
[rev2, exp2, prof2, netProf2] = calculateProfit(Feb);
[rev3, exp3, prof3, netProf3] = calculateProfit(Mar);
[rev4, exp4, prof4, netProf4] = calculateProfit(Apr);
[rev5, exp5, prof5, netProf5] = calculateProfit(May);
[rev6, exp6, prof6, netProf6] = calculateProfit(Jun);
[rev7, exp7, prof7, netProf7] = calculateProfit(Jul);
[rev8, exp8, prof8, netProf8] = calculateProfit(Aug);
[rev9, exp9, prof9, netProf9] = calculateProfit(Sep);
[rev10, exp10, prof10, netProf10] = calculateProfit(Oct);
[rev11, exp11, prof11, netProf11] = calculateProfit(Nov);
[rev12, exp12, prof12, netProf12] = calculateProfit(Dec);
